...
declare class Provider {
    ...
    buildSpendPredicate<T>(predicate: AbstractPredicate, amountToSpend: BigNumberish, receiverAddress: AbstractAddress, predicateData?: InputValue<T>[], assetId?: BytesLike, predicateOptions?: BuildPredicateOptions, walletAddress?: AbstractAddress): Promise<ScriptTransactionRequest>;
    submitSpendPredicate<T>(predicate: AbstractPredicate, amountToSpend: BigNumberish, receiverAddress: AbstractAddress, predicateData?: InputValue<T>[], assetId?: BytesLike, options?: BuildPredicateOptions, walletAddress?: AbstractAddress): Promise<TransactionResult<'success'>>;
}
 ...
 */
declare const buildBlockExplorerUrl: ({ blockExplorerUrl, path, providerUrl, address, txId, blockNumber, }: {
