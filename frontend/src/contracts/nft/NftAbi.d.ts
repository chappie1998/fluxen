...
export type ApprovalEventInput = { approved: IdentityInput, owner: IdentityInput, token_id: BigNumberish };
export type ApprovalEventOutput = { approved: IdentityOutput, owner: IdentityOutput, token_id: BN };
