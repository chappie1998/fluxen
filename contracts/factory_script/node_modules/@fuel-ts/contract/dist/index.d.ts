...
import { CallResult, TransactionResultReceipt, TransactionResponse, TransactionResult, ScriptTransactionRequest, CoinQuantity, TransactionRequest, Provider, CoinQuantityLike, CreateTransactionRequest, CreateTransactionRequestLike } from '@fuel-ts/providers';
import { BytesLike, DataOptions } from '@ethersproject/bytes';
import { AbstractAddress, AbstractContract } from '@fuel-ts/interfaces';
...
declare class FunctionInvocationResult<T = any, TTransactionType = void> extends InvocationResult<T> {
    ...
    constructor(funcScopes: InvocationScopeLike | Array<InvocationScopeLike>, transactionResponse: TransactionResponse, transactionResult: TransactionResult<any, TTransactionType>, contract: Contract, isMultiCall: boolean);
    static build<T, TTransactionType = void>(funcScope: InvocationScopeLike | Array<InvocationScopeLike>, transactionResponse: TransactionResponse, isMultiCall: boolean, contract: Contract): Promise<FunctionInvocationResult<T, TTransactionType>>;
}
...
declare class BaseInvocationScope<TReturn = any> {
    ...
    addContracts(contracts: Array<Contract>): this;
    /**
...
declare class Contract implements AbstractContract {
    ...
    constructor(id: string | AbstractAddress, abi: JsonAbi | JsonFlatAbi | Interface, walletOrProvider: BaseWalletLocked | Provider);
